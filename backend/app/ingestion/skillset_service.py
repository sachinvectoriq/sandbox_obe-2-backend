    ...
    async def create_skillset_using_sdk_async(
        ...
        skills: List = [
            ...
            WebApiSkill(
                ...
                context="/document",
                uri="https://app-ocm20-obe-dev-001-dgd8hbbyeyc2d2fv.eastus2-01.azurewebsites.net/api/footer-metadata",
                http_method="POST",
            ...
            WebApiSkill(
                ...
                uri="https://app-ocm20-obe-dev-001-dgd8hbbyeyc2d2fv.eastus2-01.azurewebsites.net/api/image-verbalization",
                http_method="POST",
                timeout=timedelta(seconds=230),
                batch_size=1,
                inputs=[
        ...
        skills: List[Dict[str, Any]] = [
            ...
            },
            {
                ...
                "inputs": [
                    ...
                    {"name": "metadata_storage_container", "source": f"='{self._blob_options.container_name}'"},
                ],
                "outputs": [
